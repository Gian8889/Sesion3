...
if sesion == "Sesion 1":
  ...
  precio = st.number.input("Ingrese el precio del producto", min_value=0, max_value=5000, value=1200)
  descuento = st.number.input("Ingrese el descuento del producto del 0 al 100%", min_value=0, max_value=100)
